...
Needs a browser canvas — wrap in `ClientOnly` (Nuxt) or equivalent when using SSR. See [Getting started](/docs/vue/getting-started#ssr--nuxt).
...
Named slots replace built-in toolbar pieces. See [Chrome slots](/docs/vue/guides/chrome-slots).
...
See [Accessibility](/docs/vue/guides/accessibility).
...
Related: [Demo](/docs/vue/demo/) · [Guides](/docs/vue/guides/feeding-data) · [LiveChartTransition](/docs/vue/livechart-transition) · [useLiveChartEngine](/docs/vue/use-live-chart-engine) · [React API](/docs/react/api/livechart) (shared engine behavior)
