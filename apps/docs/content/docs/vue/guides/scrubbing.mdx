...
With `a11y` (default on) and `scrub`, the plot is focusable and Arrow/Home/End/Escape scrub from the keyboard. See [Accessibility](/docs/vue/guides/accessibility).
