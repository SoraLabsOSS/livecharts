...
See [LiveChartEngine](/docs/react/api/livechart-engine) and [useLiveChartEngine](/docs/react/api/use-live-chart-engine). Vue bindings: [`livecharts/vue`](/docs/vue/).
...
Drawing and animation core started from [Liveline](https://github.com/benjitaylor/liveline) (Benji Taylor, MIT). This package splits that engine from React, adds Vue / data entries, and documents the public API. Notices ship in the published [LICENSE](https://github.com/SoraLabsOSS/livecharts/blob/main/packages/livecharts/LICENSE).
