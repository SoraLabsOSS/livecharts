...
Toggle chips appear automatically when there is more than one series. The last visible series cannot be hidden. See [Multi-series](/docs/react/guides/multi-series).
...
Prefer [`aggregateCandles`](/docs/react/api/data-helpers) from `livecharts/data` instead of hand-rolling OHLC buckets.
...
Documented in [Reference line](/docs/react/guides/reference-line) and [Orderbook](/docs/react/guides/orderbook).
