...
- **Chrome slots / render props** — shipped: `renderWindows` / `renderModeToggle` / `renderSeriesToggle` (React) and `#windows` / `#mode-toggle` / `#series-toggle` (Vue). See [Chrome slots](/docs/react/guides/chrome-slots)
- **Accessibility v1** — shipped: keyboard scrub + polite live region. See [Accessibility](/docs/react/guides/accessibility)
