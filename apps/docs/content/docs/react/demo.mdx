...
<Cards>
  <Card title="Getting started" href="/docs/react/getting-started" />
  <Card title="LiveChart props" href="/docs/react/api/livechart" />
  <Card title="Guides" href="/docs/react/guides/feeding-data" />
</Cards>
