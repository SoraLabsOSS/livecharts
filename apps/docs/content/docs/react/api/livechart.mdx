...
Replace built-in toolbar pieces with custom DOM. See [Chrome slots](/docs/react/guides/chrome-slots).
...
See [Accessibility](/docs/react/guides/accessibility).
...
Related: [Types](/docs/react/api/types) · [Guides](/docs/react/guides/feeding-data) · [Demo](/docs/react/demo/)
