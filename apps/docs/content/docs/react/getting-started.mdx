...
See [Effects](/docs/react/guides/effects) for `exaggerate`, badge variants, and more.

## Next steps

<Cards>
  <Card title="Data model" href="/docs/react/concepts/data-model" />
  <Card title="Feeding live data" href="/docs/react/guides/feeding-data" />
  <Card title="Theming" href="/docs/react/guides/theming" />
  <Card title="Full props" href="/docs/react/api/livechart" />
</Cards>
